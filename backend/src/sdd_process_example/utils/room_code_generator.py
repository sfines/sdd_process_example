...
WORD_LIST = [
    ...
    "EAGLE", "FALCON", "GIRAFFE", "HORSE", "IGUANA",
    "JAGUAR", "KOALA", "LION", "MONKEY", "NEWT",
    "OTTER", "PANDA", "QUAIL", "RABBIT", "SNAKE",
    "TIGER", "UNICORN", "VIPER", "WALRUS", "XERUS",
    "YAK", "ZEBRA", "AZURE", "BRONZE", "COPPER",
    "DIAMOND", "EMERALD", "FROST", "GOLDEN", "HOLLOW",
    "IVORY", "JADE", "KNIGHT", "LUNAR", "MYSTIC",
    "NOBLE", "ONYX", "PEARL", "QUARTZ", "RUBY",
    "SILVER", "TOPAZ", "ULTRA", "VIOLET", "WINTER",
    "XENON", "YELLOW", "ZENITH", "AMBER", "BLAZE",
    "CRYSTAL", "DAWN", "EMBER", "FLAME", "GLACIER",
    "HAVEN", "IRON", "JEWEL", "KARMA", "LIGHT",
    "MAGIC", "NIGHT", "OCEAN", "PRISM", "QUEST",
    "RAVEN", "SHADOW", "THUNDER", "UNITY", "VAPOR",
    "WAVE", "WIZARD", "ZODIAC", "ARROW", "BLADE",
]
